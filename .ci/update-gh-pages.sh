...
GH_PAGES_REPO_FROM_SLUG="github.com/terrestris/geoserver-introduction-ws.git"
GH_PAGES_REPO="https://$GH_PAGES_REPO_FROM_SLUG"
GH_PAGES_REPO_AUTHENTICATED="https://$GHTOKEN@$GH_PAGES_REPO_FROM_SLUG"
GH_PAGES_DIR=/tmp/geoserver-introduction-ws-gh-pages
...
cp -r $SRC_DIR/geoserver-introduction-ws/* .
